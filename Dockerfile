...
# Install necessary tools (e.g., wget, unzip) if not already present
...
RUN sdkmanager --install 'platforms;android-35' --sdk_root=/opt/unity/Editor/Data/PlaybackEngines/AndroidPlayer/SDK
